...
class HansHelper(object):
    ...
    def get_indices_of_heuristic(
            self,
            mode: str,       # Thean ["train", "eval"]
            heuristic: str   # Thean i.e. ["lexical_overlap", "subsequence", "constituent"]
    ) -> List[int]:
    ...
    # Thean add: data is sampled randomly everytime this function is called
